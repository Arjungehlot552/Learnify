...
const ProjectDetailMentor = () => {
  ...
  return (
    <div
      className={`h-fit min-h-[800px] w-full bg-gradient-to-tr ${
        colorMode === "light"
    ...
    >
      <div
        ...
        } flex p-8 rounded-2xl flex-col items-start justify-center gap-5`}
      >
        ...
        <p>
          <strong style={gradientTextStyle}>Company:</strong>{" "}
          {project[1].company}
        </p>
        <p>
          <strong style={gradientTextStyle}>Designation:</strong>{" "}
          {project[1].designation}
        </p>
        <p>
