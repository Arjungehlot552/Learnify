...
const UserGuidelines = () => {
  ...
  return (
    ...
    <p className="w-full flex items-center justify-center text-center bg-clip-text text-transparent bg-gradient-to-r  from-red-400 via-pink to-blue-400 mb-8 font-bold text-8xl">
      Learnify User Guidelines
    </p>

    <section className="mb-10 rounded-lg shadow-md shadow-red-400 p-4">
